package com.gudsen.moza.log;

import com.gudsen.moza.log.model.ConfigMap;
import com.gudsen.moza.log.model.NginxLogModel;
...
public class NginxLogService {
    ...
    private long getLastFilePosition() {
        ...
        ConfigMap configMap = mongoTemplate.findOne(query, ConfigMap.class);
        if (configMap == null) return 0L;
        return Long.parseLong(configMap.value);
    }
    ...
    private void setFilePosition(long lastFilePosition) {
        ...
        UpdateResult upsert = mongoTemplate.upsert(query, update, ConfigMap.class);
